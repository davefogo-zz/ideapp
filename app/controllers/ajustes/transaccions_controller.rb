  ...
  private
    def set_transaccion
  	...
  	def transaccion_params
  		params.require(:transaccion).permit(:fecha, :credito, :debito, :iva, :subcuenta_puc_id, :factura_item_id, :factura_proveedor_id, :gasto_id, :recibo_de_caja_id, :numero_de_documento, :cliente_id, :ajuste_id)
  	end
end
