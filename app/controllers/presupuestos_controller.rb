class PresupuestosController < ApplicationController
  ...
  private
    ...
    def presupuesto_params
      params.require(:presupuesto).permit(:fecha, :cliente, :nit, :dirección, :teléfono, :contacto_financiero, :contacto_comercial, :ejecutivo, :agencia, :nit_agencia, :titulo, :producto, :colaboradore_id)
    end
end
